...
export const PermissionForm = ({ initialData, onSubmit, isLoading, title, onCancel }: PermissionFormProps) => {
    const { register, handleSubmit, reset, formState: { errors } } = useForm<PermissionRequest>({
